...
class Login extends JFrame implements ActionListener{
    ...
    Login()
    {
        ...
        try{
            ...
            // bank icon
            ImageIcon img = new ImageIcon("images/bank1.png");
        ...
        JLabel text  = new JLabel("Welcome to Digital Bank ATM");
        text.setBounds(200,60,1000, 60);
        text.setFont(new Font("Times new Roman", Font.BOLD, 30));
        add(text);

        // Text after heading
        JLabel warn = new JLabel("If you are a new User, Please SignUP!!");
        warn.setBounds(250, 140, 1000, 40);
        warn.setFont(new Font("MV Boli", Font.PLAIN, 15));
        add(warn);
